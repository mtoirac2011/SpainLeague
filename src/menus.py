...
def utilitiesMenu():
    ...
    print("│                                                │")
    print("│     m - Modify current instance of SQL Server  │")
    print("│                                                │")
...
def instanceMenu(pcname):
    system("cls")
    print("            SQL Server Instance Menu  ")
    print("┌──────────────────────────────────────────────────┐")
    print("│  In this Menu you'll be able set an appropiated  │")
    print("│  connection to our instance of SQL Server.       │")
    print("│                                                  │")
    print("│  Our current instace is:                         │")
    print("│                                                  │")
    print("│  "+ str(pcname).center(46) + "  │")
    print("│                                                  │")
    print("│     c - Chage current SQL Server instance        │")
    print("│                                                  │")
    print("│     x - Exit                                     │")
    print("└──────────────────────────────────────────────────┘")
    print("")